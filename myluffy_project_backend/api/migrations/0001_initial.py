# Generated by Django 3.0.3 on 2020-03-01 08:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teachers', models.ManyToManyField(to='api.Teacher', verbose_name='课程讲师')),
            ],
        ),
        migrations.CreateModel(
            name='CouponRecord',
            fields=[
                ...
                ('order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.Order', verbose_name='关联订单')),
            ],
        ),
        migrations.CreateModel(
            name='PricePolicy',
