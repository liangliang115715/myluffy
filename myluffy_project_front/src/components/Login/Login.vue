<template>
	<div class="box">
		<img src="https://images.wallpaperscraft.com/image/stars_night_shine_128686_1920x1080.jpg" alt="">
		<div class="login">
			<div class="login-title">
				<img src="https://images.wallpaperscraft.com/image/anime_girl_cute_lights_night_16812_300x168.jpg" alt="">
...
//                });
                ...
                localStorage.setItem('avatar',res.data.userinfo.head_img );
